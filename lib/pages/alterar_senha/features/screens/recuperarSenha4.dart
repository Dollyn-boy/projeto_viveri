...
class _recuperarSenha4State extends State<recuperarSenha4> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        //  Centraliza o conteúdo (Container) na tela
        child: Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  const Center(
                    child: Column(
                      children: [ViveriLogo(), SizedBox(height: 0)],
                    ),
                  ),
                      ...
                      child: ElevatedButton(
                        onPressed: _isLoading
                            ...
                            : () async {
                                ...
                                if (email.isNotEmpty) {
                                  // Chama o Django
                                  bool sucesso = await _apiService
                                  ...
                                  if (sucesso && context.mounted) {
                                    ...
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            recuperarSenha5(emailUser: email),
                                      ),
                                    );
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(
                                        content: Text(
                                          "Email não encontrado ou erro no servidor.",
                                        ),
                                      ),
                                    );
                                  }
