...
class _EventosCriadosPageState extends State<EventosCriadosPage>
  ...
  final List<EventoCriado> _eventosCriados = [
    EventoCriado(
      id: 1,
      image:
          'https://cdn.pixabay.com/photo/2015/11/19/21/10/festa-1052601_1280.jpg',
  ...
  Widget _buildEventListItem(BuildContext context, EventoCriado evento) {
    ...
    final String formattedTime =
        '${DateFormat('HH:mm').format(evento.horaInicio)} - ${DateFormat('HH:mm').format(evento.horaFim)}';
    ...
    final favoritosList = ListView.builder(
      ...
      itemBuilder: (context, index) {
        return _buildEventListItem(
          context,
          controller.eventosFavoritados[index],
        );
      },
    );
